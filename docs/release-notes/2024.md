...
- Updated description for `legal_short_name` in add_application, and `/submit_additional_documents` and `/upload_additional_files` endpoint descriptions for clarity.
