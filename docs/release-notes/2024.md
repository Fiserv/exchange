...
- Updated /transaction , /transaction/chargeback-adjustments, /transaction/chargebacks response
- Updated Bank Description, bank_account_type description, contacts description
- Update Maintenance object example fixed to correctly show array.
